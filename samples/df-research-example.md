# df-research worked example

Produced by `bash scripts/df-research.sh run "How effective are LLM-generated code review comments at finding real defects compared to human reviewers?" --depth quick`

Audit: 38 distinct sources (34 primary, 3 social), 6 contradiction clusters, 149 supported
citations, 0 unsupported, 0 fabricated — after one remediation pass fixed 6 unsupported cites.
